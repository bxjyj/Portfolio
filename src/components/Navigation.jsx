...
const Navigation = () => {
  ...
  // Only show the Experience link once there's actually something to show.
  const navItems = [
    { name: 'About', id: 'about' },
    ...(experienceData.length > 0 ? [{ name: 'Experience', id: 'experience' }] : []),
  ...
  const scrollToSection = (sectionId) => {
    ...
    if (location.pathname !== '/') {
      // Navigate home first, then Home.jsx scrolls once it's mounted.
