...
const visibleProjects = projectsData.filter((project) => !project.draft);
...
const Projects = () => {
  ...
  const displayProjects = showAll ? visibleProjects : featuredProjects;
    ...
    >
      <div className="relative overflow-hidden">
        <img
          src={project.image}
          alt={project.title}
          className="w-full h-64 md:h-48 lg:h-56 object-cover group-hover:scale-105 transition-transform duration-300"
        />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-left mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            A collection of data science, GIS, and software projects showcasing my work across
            spatial analysis, machine learning, and engineering.
          </p>
        </div>
        ...
        {displayProjects.length > 0 ? (
          ...
          <p className="text-gray-400 mb-12">No projects yet — add one in src/data/projects.js.</p>
        )}

        {visibleProjects.length > featuredProjects.length && (
