...
const visiblePosts = blogData.filter((post) => !post.draft);
...
const Blog = () => {
  ...
  const displayPosts = showAll ? visiblePosts : featuredPosts;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-left mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Thoughts on data science, GIS, and leadership outside of the classroom
          </p>
        </div>
        ...
        {displayPosts.length > 0 ? (
          ...
          <p className="text-gray-400 mb-12">No posts yet — add one in src/data/blog.js.</p>
        )}
