          ...
          <div className="space-y-8 fade-in-up">
            <div className="space-y-4">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-500">
                Data Scientist &amp; Spatial Analyst
              </h2>
            </div>

            <p className="text-lg md:text-xl text-gray-400 leading-relaxed max-w-2xl">
              I build data-driven, geospatial solutions — from ArcGIS-based conflict modeling to
              machine learning pipelines — and I write the software to ship them.
            </p>
